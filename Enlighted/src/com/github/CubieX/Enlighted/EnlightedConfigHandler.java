...
import com.github.CubieX.Enlighted.Enlighted;

public class EnlightedConfigHandler 
{
   private FileConfiguration config;
   private final Enlighted plugin;

   public EnlightedConfigHandler(Enlighted plugin) 
   {
      this.plugin = plugin;      
